...
TEST_F(GridTest, TEST_GRID_DEFAULT)
{
  ...
  EXPECT_NO_THROW(default_grid.atCellSafe(3,3));
...
TEST_F(GridTest, TEST_GRID)
{
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1, grid.atPosition(0,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1, grid.atPosition(0,1)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1, grid.atPosition(0,2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2, grid.atPosition(0,3)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3, grid.atPosition(0,4)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1, grid.atPosition(1,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(0, grid.atPosition(1,1)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1, grid.atPosition(1,2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2, grid.atPosition(1,3)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3, grid.atPosition(1,4)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1, grid.atPosition(2,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1, grid.atPosition(2,1)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1, grid.atPosition(2,2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2, grid.atPosition(2,3)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3, grid.atPosition(2,4)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2, grid.atPosition(3,0)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3, grid.atPosition(3,4)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0,1./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0,2./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(0,3./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(0,4./2)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(1./2,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(0./2, grid.atPosition(1./2.,1./2.)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(1./2,2./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(1./2,3./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(1./2,4./2)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2,1./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2,2./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(2./2,3./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(2./2,4./2)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(3./2,0)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(3./2,4./2)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0+1.2,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0+1.2,1./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0+1.2,2./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(0+1.2,3./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(0+1.2,4./2)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(1./2.+1.2,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(0./2, grid.atPosition(1./2.+1.2,1./2.)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(1./2.+1.2,2./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(1./2.+1.2,3./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(1./2.+1.2,4./2)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2.+1.2,0)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2.+1.2,1./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2.+1.2,2./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(2./2.+1.2,3./2)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(2./2.+1.2,4./2)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(3./2.+1.2,0)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(3./2.+1.2,4./2)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0+1.2,0.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0+1.2,1./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(0+1.2,2./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(0+1.2,3./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(0+1.2,4./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4./2, grid.atPosition(0+1.2,5./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5./2, grid.atPosition(0+1.2,6./2.+4.7)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(1./2.+1.2,0.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(0./2, grid.atPosition(1./2.+1.2,1./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(1./2.+1.2,2./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(1./2.+1.2,3./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(1./2.+1.2,4./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4./2, grid.atPosition(1./2.+1.2,5./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5./2, grid.atPosition(1./2.+1.2,6./2.+4.7)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2.+1.2,0.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2.+1.2,1./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(1./2, grid.atPosition(2./2.+1.2,2./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(2./2.+1.2,3./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(2./2.+1.2,4./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4./2, grid.atPosition(2./2.+1.2,5./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5./2, grid.atPosition(2./2.+1.2,6./2.+4.7)));

  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(2./2, grid.atPosition(3./2.+1.2,0.+4.7)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3./2, grid.atPosition(3./2.+1.2,4./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4./2, grid.atPosition(3./2.+1.2,5./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5./2, grid.atPosition(3./2.+1.2,6./2.+4.7)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4./2, grid.atPosition(4./2.+1.2,5./2.+4.7)));
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5./2, grid.atPosition(4./2.+1.2,6./2.+4.7)));
  ...
  px=0; py=5; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4.* grid.getResolution(), grid.atPosition(px,py)));
  px=0; py=6; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5.* grid.getResolution(), grid.atPosition(px,py)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3.* grid.getResolution(), grid.atPosition(px,py)));
  px=1; py=5; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4.* grid.getResolution(), grid.atPosition(px,py)));
  px=1; py=6; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5.* grid.getResolution(), grid.atPosition(px,py)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3.* grid.getResolution(), grid.atPosition(px,py)));
  px=2; py=5; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4.* grid.getResolution(), grid.atPosition(px,py)));
  px=2; py=6; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5.* grid.getResolution(), grid.atPosition(px,py)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3.* grid.getResolution(), grid.atPosition(px,py)));
  px=3; py=5; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4.* grid.getResolution(), grid.atPosition(px,py)));
  px=3; py=6; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5.* grid.getResolution(), grid.atPosition(px,py)));
  ...
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(3.* grid.getResolution(), grid.atPosition(px,py)));
  px=4; py=5; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(4.* grid.getResolution(), grid.atPosition(px,py)));
  px=4; py=6; proj(px, py);
  EXPECT_NO_THROW(EXPECT_DOUBLE_EQ(5.* grid.getResolution(), grid.atPosition(px,py)));
}
